...
public class Reporter : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        size.x = size.y = PlayerPrefs.GetFloat("Reporter_size", 64);
    ...
    void drawToolBar()
    {
        ...
        if (GUILayout.Button(logContent, nonStyle, GUILayout.Width(size.x), GUILayout.Height(size.y * 2)))
        {
            showLog = !showLog;
            calculateCurrentLog();
        }
        if (GUILayout.Button(logsText, nonStyle, GUILayout.Width(size.x), GUILayout.Height(size.y * 2)))
        {
            showLog = !showLog;
            calculateCurrentLog();
        }
        ...
        if (GUILayout.Button(warningContent, nonStyle, GUILayout.Width(size.x), GUILayout.Height(size.y * 2)))
        {
            showWarning = !showWarning;
            calculateCurrentLog();
        }
        if (GUILayout.Button(logsWarningText, nonStyle, GUILayout.Width(size.x), GUILayout.Height(size.y * 2)))
        {
            showWarning = !showWarning;
            calculateCurrentLog();
        }
        ...
        if (GUILayout.Button(errorContent, nonStyle, GUILayout.Width(size.x), GUILayout.Height(size.y * 2)))
        {
            showError = !showError;
            calculateCurrentLog();
        }
        if (GUILayout.Button(logsErrorText, nonStyle, GUILayout.Width(size.x), GUILayout.Height(size.y * 2)))
        {
            showError = !showError;
            calculateCurrentLog();
        }
